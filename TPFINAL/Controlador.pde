class Controlador {
  ...
  Controlador() {
    ...
    pantallas[pantalla] = new Pantalla(rezise,fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton1, boton2, null, null, null, cursor);

    pantalla = 1;
    boton1 = new Boton( rezise,939, 700, 2);
    pantallas[pantalla] = new Pantalla(rezise,fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton1, null, null, null, null, cursor);
    ...
    creditos = new Creditos(rezise, textos.getTextoParaPantalla(pantalla), 100, 780);
    pantallas[pantalla] = new Pantalla(rezise,fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton1, null, creditos, null, null, cursor);
    ...
    pantalla = 36;
    boton1=new Boton(rezise,435, 186, 37);
    juego=new Juego();
    pantallas[pantalla] = new Pantalla(rezise,fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton1, null, null, juego, null, null);

    pantalla = 37;
    boton1=new Boton(rezise,772, 608, 28);
    bambuPiedra=new BambuPiedra();
    pantallas[pantalla] = new Pantalla(rezise,fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton1, null, null, null, bambuPiedra, null);
